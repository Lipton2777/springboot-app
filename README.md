...
<b>Answer:</b> You will have to deploy an application into a k8s cluster, preferably in the cloud(eks/aks etc). The application developers will provide a github repo link of the application containing ‘n’
...
###  5. Expose the application publicly and send us the URL to access the application.
